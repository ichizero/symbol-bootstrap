...
import { LoggerFactory, LogType, PrivateKeySecurityMode, ZipUtils } from '../../src';
...
describe('BootstrapService config', () => {
    ...
    after(async () => {
        ...
        // NOTE: if tests has failed, compare test/expectedTargets.zip and target/expectedTargets.zip with intellij for example.
